...
Install-ChocolateyShortcut `
    -ShortcutFilePath "$env:USERPROFILE\Desktop\DHCP.lnk" `
    -TargetPath 'C:\Windows\System32\dhcpmgmt.msc'
Install-ChocolateyShortcut `
    -ShortcutFilePath "$env:USERPROFILE\Desktop\Windows Deployment Services.lnk" `
    -TargetPath 'C:\Windows\System32\WdsMgmt.msc'
